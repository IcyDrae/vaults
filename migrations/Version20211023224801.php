 ...
 */
final class Version20211023224801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, vault_id INT NOT NULL, data LONGTEXT NOT NULL, INDEX IDX_64C19C1A76ED395 (user_id), INDEX IDX_64C19C158AC2DF8 (vault_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE login (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, vault_id INT NOT NULL, category_id INT DEFAULT NULL, data LONGTEXT NOT NULL, INDEX IDX_AA08CB10A76ED395 (user_id), INDEX IDX_AA08CB1058AC2DF8 (vault_id), INDEX IDX_AA08CB1012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, vault_id INT NOT NULL, category_id INT DEFAULT NULL, data VARCHAR(255) NOT NULL, INDEX IDX_CFBDFA14A76ED395 (user_id), INDEX IDX_CFBDFA1458AC2DF8 (vault_id), INDEX IDX_CFBDFA1412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
